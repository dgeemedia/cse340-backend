-- Re-runnable script (no BEGIN/COMMIT) — paste into pgAdmin and Execute

-- Drop existing objects if present (keeps script idempotent)
...
-- Optional: change owner (adjust role if needed)
